...
# and saves the new arrays in a csv file according on the spectrum phases (regular epoch bins).
...
# directories used
dir_txt = 'C:/Users/Cristina/Documents/uni/4B/TFG/Regular_bin_sizes/txt/' # directory of the txt files with the spectrum names files
dir_spectrum = 'C:/Users/Cristina/Documents/uni/4B/TFG/dataset/corrected_dataset/' # directory of the spectrum files
