...
dir_outputs = 'C:/Users/Cristina/Documents/uni/4B/TFG/Variable_bin_sizes/output_flux/' # directory of the spectrum matrices
...
for file_csv in os.listdir():
    ...
    for rows in csv_reader:
        ...
        # initalization of the arrays for the new spectrum
        distances = []
